        ...
        <div className="bg-white rounded-md p-6 w-full ">
            <form className="w-full space-y-4" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <Input placeholder="e.g., Finalize structural schematics" type="text" id="title" {...register("title")} error={errors.title?.message} />
                </div>
            ...
            {errorMsg && <p className="text-error text-sm font-normal mt-2">{errorMsg}</p>}
        </div>
    )
}